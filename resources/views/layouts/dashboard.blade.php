            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a  data-toggle="collapse" href="#websites"><i class="fa fa-globe fa-fw"></i> Websites<span class="fa arrow"></span></a>

                            <ul id="websites" class="nav nav-second-level collapse">
                                <li {{ (Request::is('websites.index') ? 'class="active"' : '') }}>
                                    <a href="{{ route('websites.index') }}">All websites</a>
                                </li>
                                <li {{ (Request::is('websites.create') ? 'class="active"' : '') }}>
                                    <a href="{{ route('websites.create') }}">Add new website</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
